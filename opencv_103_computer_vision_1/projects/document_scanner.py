...
# -------------->>>>>>> ADD DOCUMENT AS SYS ARGUMENT OR CHANGE DATA PATH ON LINE 18 <<<<<<<----------------------------
# -------------->>>>>>> KEY: 'N' TO BINARIZE IMAGE, KEY 'S' TO WARP AND FINALIZE <<<<<<--------------------------------
...
Aspect ratio is that of a legal document (8.5x11)
"""

DATA_PATH = "/home/david/PycharmProjects/opencv/projects/document_scanner/"
